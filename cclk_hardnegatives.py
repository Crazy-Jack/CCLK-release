...
parser.add_argument("--distance_mode", default="dotProduct")
...
# folder name
args.save_folder = f"{args.save_path}/{args.condition_mode}-v2/{args.dataset}/bz_{args.batch_size}_ep_{args.num_epochs}"
...
def train(epoch, args, high_threshold, low_threshold):
    ...
    for batch_idx, (inputs, _, _) in t:
        ...
        if z_head is not None:
            z1, z2 = z_head(representation1), z_head(representation2)
        else:
            z1, z2 = representation1, representation2
